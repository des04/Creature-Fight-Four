...
public class Creature extends Actor
{
    ...
    /**
     * switchCreature will be a method for subclasses that allows the player to switch to a creature of his/her choosing
     * 
     * @param An integer called idx which represents the index for an array which basically contains creatures
     * @return Nothing is returned
     * 
    ...
    /**
     * switchedIn will be a method for subclasses that will be called whenever a creature is switched in.
     * 
     * @param There are no parameters
     * @return Nothing is returned
     * 
